            ...
            <div class="content-wrapper">
                        ...
                        <div class="page-header">
                            <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                                <ul class="quick-links" style="padding-left: 0;">
                                    <li><a href="{{ route('infirmTypeIntervList') }}">Types interventions</a></li>
                                </ul>
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulaire de gestion des types d'interventions</h4>
                                <form class="form-sample" action="{{ route('typeIntervention.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label for="libelle">Libelle</label>
                                                <input type="text" name="nomType" class="form-control" id="libelle" placeholder="Libelle du type d'intervention" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="desctypesoin">Description</label>
                                                <textarea name="description" class="form-control" id="desctypesoin" rows="2"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
