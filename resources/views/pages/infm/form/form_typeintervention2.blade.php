            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Formulaire de gestion des types dinterventions</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nomType" value="{{ $typeInter->nomType }}" class="form-control" id="libelle" placeholder="Libelle du type d'intervention" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="desctypesoin">Description</label>
                                                <textarea name="description" class="form-control" id="desctypesoin" rows="2">{{ $typeInter->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
