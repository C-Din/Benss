                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap mt-5">
                                        <ul class="quick-links" style="padding-left: 0;">
                                            <li>
                                                <h4 class="card-title" style="margin-bottom: 0;">Liste des Interventions du patient</h4>
                                            </li>
                                        </ul>
                                    </div>
                                    <table class="table table-bordered table-hover mt-2">
                                        ...
                                        <tbody>
                                            @foreach($interventionPatient as $interv)
                                            <tr>
                                                <td> {{ ++$i }} </td>
                                                ...
                                                <td style="text-align: center;">
                                                    <a type="button" href="{{ route('') }}" class="btn btn-icons btn-inverse-secondary">
