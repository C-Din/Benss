                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" action="{{ route('typeRdv.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label for="libelle">Libelle</label>
                                                <input type="text" name="nomType" class="form-control" id="libelle" placeholder="Libelle du type de rendez-vous" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
