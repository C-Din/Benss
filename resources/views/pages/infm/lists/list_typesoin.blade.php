                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                            <ul class="quick-links" style="padding-left: 0;">
                                <li>
                                <h4 class="card-title" style="margin-bottom: 0;">Liste des types de rendez-vous</h4>
                                </li>
                            </ul>
                            <ul class="quick-links ml-auto">
                                <li>
                                    <a href="{{ route('typeRdv.create') }}" type="button" class="btn btn-primary btn-fw" style="color: #fff; width: auto; min-width: auto; padding-right: 24px;">
                            ...
                            <tbody>
                                @foreach($typesRdv as $typeRdv)
                                    <tr>
                                        <td> {{ ++$i }} </td>
                                        <td> {{ $typeRdv->nomType }} </td>
                                        <td> {{ $typeRdv->description }} </td>
                                        <td style="text-align: center;">
                                            <form action="{{ route('typeRdv.destroy',$typeRdv->id) }}" method="POST">
                                                <a  href="{{ route('typeRdv.show',$typeRdv->id) }}" class="btn btn-icons btn-inverse-secondary">
                                                    <i class="mdi mdi-eye"></i>
                                                    </a>
                                                    <a href="{{ route('typeRdv.show',$typeRdv->id) }}" class="btn btn-icons btn-inverse-success">
