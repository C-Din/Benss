<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav" style="position: fixed; padding-left: 24px; margin-bottom: auto;">
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{ route('comptelistAdmin') }}">
        <i class="menu-icon typcn typcn-document-text"></i>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('medecin.index') }}">Medecins</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('infirmiere.index') }}">Infirmiers</a>
          </li>
          <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="{{ route('rdv.index') }}">RDV</a>
          </li>
          <li class="nav-item">
